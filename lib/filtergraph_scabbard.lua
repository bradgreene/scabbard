...
local function new_filter_graph(x_min, x_max, y_min, y_max)
  local graph = Graph.new(x_min or 10, x_max or 24000, "lin", y_min or -60, y_max or 30, "lin", "spline", true, true)
...
local function update_points(self)
  ...
  elseif filter_type == "highpass" then
    ...
    self:edit_point(2, freq * 0.75, 0)
    self:edit_point(3, freq * 0.2, 0)
